...
inline ValueType atomic_add(Device ValueType& data, Device FlagType& flag, ConstRef(ValueType) add_value) {
    return atomic_template_fetch(flag, spinning, func_add<ValueType>, data, add_value);
}
template<typename ValueType>
inline ValueType atomic_sub(Device ValueType& data, Device FlagType& flag, ConstRef(ValueType) sub_value) {
    return atomic_template_fetch(flag, spinning, func_sub<ValueType>, data, sub_value);
}
template<typename ValueType>
inline ValueType atomic_min(Device ValueType& data, Device FlagType& flag, ConstRef(ValueType) min_value) {
    return atomic_template_fetch(flag, spinning, func_min<ValueType>, data, min_value);
}
template<typename ValueType>
inline ValueType atomic_cas(Device ValueType& data, Device FlagType& flag, ConstRef(ValueType) compare_value, ConstRef(ValueType) exchange_value) {
...
inline void atomic_add(Device float& data, ConstRef(float) add_value) { Device ATOMIC_FLOAT* tmp = float_to_atomic_ptr(data); atomic_fetch_add_explicit(tmp, add_value, memory_order_relaxed); }
inline void atomic_sub(Device float& data, ConstRef(float) add_value) { Device ATOMIC_FLOAT* tmp = float_to_atomic_ptr(data); atomic_fetch_sub_explicit(tmp, add_value, memory_order_relaxed); }

inline void atomic_add(Device atomic_float* ptr, ConstRef(uint) addr, ConstRef(float) add_value) { atomic_fetch_add_explicit(&ptr[addr], add_value, memory_order_relaxed); }
inline void atomic_sub(Device atomic_float* ptr, ConstRef(uint) addr, ConstRef(float) add_value) { atomic_fetch_sub_explicit(&ptr[addr], add_value, memory_order_relaxed); }
...
// Float3
inline void atomic_add(Device atomic_float* ptr, ConstRef(uint) addr, ConstRef(Float3) add_value) {
...
inline void atomic_sub(Device atomic_float* ptr, ConstRef(uint) addr, ConstRef(Float3) sub_value) {
...
// inline void atomic_max(Device atomic_float* ptr, ConstRef(uint) addr, ConstRef(Float3) max_value) {
...
// }
// inline void atomic_min(Device atomic_float* ptr, ConstRef(uint) addr, ConstRef(Float3) min_value) {
...
// }
// inline void atomic_aabb(Device atomic_float* ptr, ConstRef(uint) addr, ConstRef(AABB) aabb) {
...
// Float3x3
inline void atomic_add(Device atomic_float* ptr, ConstRef(uint) addr, ConstRef(Float3x3) add_value) {
...
inline void atomic_sub(Device atomic_float* ptr, ConstRef(uint) addr, ConstRef(Float3x3) sub_value) {
...
inline ValueType atomic_cas(Device AtomicType& data, ValueType compare_value, ConstRef(ValueType) exchange_value){
...
template<typename ValueType, typename AtomicType>
inline void atomic_store(Device AtomicType& data, ConstRef(ValueType) store_value){ atomic_store_explicit(&data, store_value, memory_order_relaxed); }
#else
template<typename ValueType, typename AtomicType>
inline ValueType atomic_cas(Device AtomicType& data, ValueType compare_value, ConstRef(ValueType) exchange_value) {
...
template<typename ValueType, typename AtomicType>
inline void atomic_store(Device AtomicType& data, ConstRef(ValueType) store_value){ std::atomic_store(&data, store_value); }
#endif
...
inline uint atomic_add(Device      ATOMIC_UINT& data, ConstRef(uint) add_value){ return atomic_fetch_add_explicit(&data, add_value, memory_order_relaxed); }
...
inline uint atomic_sub(Device      ATOMIC_UINT& data, ConstRef(uint) sub_value){ return atomic_fetch_sub_explicit(&data, sub_value, memory_order_relaxed); }
...
inline uint atomic_or (Device      ATOMIC_UINT& data, ConstRef(uint) or_value) { return atomic_fetch_or_explicit(&data, or_value, memory_order_relaxed); }
...
inline uint atomic_and(Device      ATOMIC_UINT& data, ConstRef(uint) and_value){ return atomic_fetch_and_explicit(&data, and_value, memory_order_relaxed); }
#else
...
inline uint atomic_add(Device      uint& data, ConstRef(uint) add_value){ return atomic_fetch_add_explicit((Device      ATOMIC_UINT*)(&data), add_value, memory_order_relaxed); }
...
inline uint atomic_sub(Device      uint& data, ConstRef(uint) sub_value){ return atomic_fetch_sub_explicit((Device      ATOMIC_UINT*)(&data), sub_value, memory_order_relaxed); }
...
inline uint atomic_or (Device      uint& data, ConstRef(uint) or_value) { return atomic_fetch_or_explicit ((Device      ATOMIC_UINT*)(&data), or_value,  memory_order_relaxed); }
...
inline uint atomic_and(Device      uint& data, ConstRef(uint) and_value){ return atomic_fetch_and_explicit((Device      ATOMIC_UINT*)(&data), and_value,  memory_order_relaxed); }
...
inline uint atomic_cas(Device      uint& data, uint compare_value, ConstRef(uint) exchange_value) { atomic_compare_exchange_weak_explicit((Device      ATOMIC_UINT*)(&data), &compare_value, exchange_value, memory_order_relaxed, memory_order_relaxed); return compare_value; }
...
inline uint atomic_add(Device      int& data, ConstRef(int) add_value){ return atomic_fetch_add_explicit((Device      ATOMIC_INT*)(&data), add_value, memory_order_relaxed); }
...
inline uint atomic_sub(Device      int& data, ConstRef(int) sub_value){ return atomic_fetch_sub_explicit((Device      ATOMIC_INT*)(&data), sub_value, memory_order_relaxed); }
...
inline uint atomic_or (Device      int& data, ConstRef(int) or_value) { return atomic_fetch_or_explicit ((Device      ATOMIC_INT*)(&data), or_value,  memory_order_relaxed); }
...
inline uint atomic_and(Device      int& data, ConstRef(int) and_value){ return atomic_fetch_and_explicit((Device      ATOMIC_INT*)(&data), and_value,  memory_order_relaxed); }
...
inline uint atomic_cas(Device      int& data, int compare_value, ConstRef(int) exchange_value) { atomic_compare_exchange_weak_explicit((Device      ATOMIC_INT*)(&data), &compare_value, exchange_value, memory_order_relaxed, memory_order_relaxed); return compare_value; }
...
// template<typename T, typename AtomicT> inline T atomic_add(Device      AtomicT& data, ConstRef(T) add_value){ return atomic_fetch_add_explicit(&data, add_value, memory_order_relaxed); }
...
// template<typename T, typename AtomicT> inline T atomic_sub(Device      AtomicT& data, ConstRef(T) sub_value){ return atomic_fetch_sub_explicit(&data, sub_value, memory_order_relaxed); }
...
// template<typename T, typename AtomicT> inline T atomic_or (Device      AtomicT& data, ConstRef(T) or_value) { return atomic_fetch_or_explicit(&data, or_value, memory_order_relaxed); }
// #else
...
// template<typename T, typename AtomicT> inline uint atomic_add(Device      uint& data, ConstRef(uint) add_value){ Device      ATOMIC_UINT* tmp = (Device      ATOMIC_UINT*)(&data); return atomic_fetch_add_explicit(tmp, add_value, memory_order_relaxed); }
...
// template<typename T, typename AtomicT> inline uint atomic_sub(Device      uint& data, ConstRef(uint) sub_value){ Device      ATOMIC_UINT* tmp = (Device      ATOMIC_UINT*)(&data); return atomic_fetch_sub_explicit(tmp, sub_value, memory_order_relaxed); }
...
// template<typename T, typename AtomicT> inline uint atomic_or (Device      uint& data, ConstRef(uint) or_value) { Device      ATOMIC_UINT* tmp = (Device      ATOMIC_UINT*)(&data); return atomic_fetch_or_explicit (tmp, or_value,  memory_order_relaxed); }
// #else
...
// template<typename T, typename AtomicT> inline T atomic_add(Device      T* data, ConstRef(T) add_value){ Device      AtomicT* tmp = (Device      AtomicT*)(data); return atomic_fetch_add_explicit(tmp, add_value, memory_order_relaxed); }
...
// template<typename T, typename AtomicT> inline T atomic_sub(Device      T* data, ConstRef(T) sub_value){ Device      AtomicT* tmp = (Device      AtomicT*)(data); return atomic_fetch_sub_explicit(tmp, sub_value, memory_order_relaxed); }
...
// template<typename T, typename AtomicT> inline T atomic_or (Device      T* data, ConstRef(T) or_value) { Device      AtomicT* tmp = (Device      AtomicT*)(data); return atomic_fetch_or_explicit (tmp, or_value,  memory_order_relaxed); }
// #else
